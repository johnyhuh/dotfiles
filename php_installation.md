...
/usr/local/opt/mysql/bin/mysqladmin -u root -h Johns-MacBook-Pro.local password 'new-password'
...
# this wild cards *.v.com, so v.com, site.v.com, etc. point to 127.0.0.1
